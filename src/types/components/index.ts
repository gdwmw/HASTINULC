import { EXAMPLEA_COLOR_OPTIONS, EXAMPLEA_SIZE_OPTIONS, EXAMPLEA_VARIANT_OPTIONS, EXAMPLEC_COLOR_OPTIONS, LABEL_COLOR_OPTIONS } from "@/src/libs";
...
export type TLabelColor = (typeof LABEL_COLOR_OPTIONS)[number];
